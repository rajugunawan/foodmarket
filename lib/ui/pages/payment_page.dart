...
class PaymentPage extends StatefulWidget {
  ...
  PaymentPage({this.transaction, this.onBackButtonPressed});
    ...
    return GeneralPage(
      ...
      child: Column(
        children: [
          ...
          //// Checkout Button
          (isLoading) ? Center(child: loadingIndicator,) : Container(
              ...
              onPressed: ()  async {
                ...
                if(result == true){
                  ...
                  Get.snackbar("", "",
                    ...
                    messageText: Text('Please try again latter', style: GoogleFonts.poppins(
                      color: Colors.white) 
